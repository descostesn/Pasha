...
readAlignedData = function(folderName, fileName, fileType="BAM", pairedEnds=FALSE)
{
    ...
    if(fileType=="BAM")
    {
        ...
        dataBAM <- scanBam(file=myFile, param=ScanBamParam(simpleCigar=TRUE, flag=scanBamFlag(isSecondaryAlignment=FALSE), what=c("mapq", "pos", "strand", "rname", "qname", "isize", "qwidth", "flag", "mrnm", "groupid", "mate_status")))[[1]]
